...
#### [8.0.2](https://github.com//avoidwork/tiny-lru.git/compare/8.0.1...8.0.2)

- Include missing props in the TypeScript definition [`#52`](https://github.com//avoidwork/tiny-lru.git/pull/52)
- Updating CHANGELOG.md [`d5ed34f`](https://github.com//avoidwork/tiny-lru.git/commit/d5ed34f2b9f058d759b2e24e48a552e97fd7d2b5)
- Version bump to release [`177bbb9`](https://github.com//avoidwork/tiny-lru.git/commit/177bbb9f0f7b3da0bdc3c2fab78b91b34c9792d1)
- update TypeScript definition [`75c88df`](https://github.com//avoidwork/tiny-lru.git/commit/75c88df3dc356527e4e70b216b7e3ca6ee6b6f82)

#### [8.0.1](https://github.com//avoidwork/tiny-lru.git/compare/8.0.0...8.0.1)

> 13 February 2022

- Fix evict() for sizes 0 & 1 [`#50`](https://github.com//avoidwork/tiny-lru.git/pull/50)
- Updating CHANGELOG.md [`29c810c`](https://github.com//avoidwork/tiny-lru.git/commit/29c810cc0a5895753ae919233b04db1ceef06ce9)
- Fixing `evict()` such that it handles a size of 0 and 1 properly [`c00f2cb`](https://github.com//avoidwork/tiny-lru.git/commit/c00f2cbcf861eb78516fd10f5b2c054a6f1929e7)
- Adding test case for issue #46 [`39a2161`](https://github.com//avoidwork/tiny-lru.git/commit/39a2161e6b359c67c87b0936da3bd1f42f5e0a8c)

### [8.0.0](https://github.com//avoidwork/tiny-lru.git/compare/7.0.6...8.0.0)

> 13 February 2022

- Removing creeping `expiry` behavior [`#49`](https://github.com//avoidwork/tiny-lru.git/pull/49)
- Removing creeping `expiry` behavior - it's an old flaw that keeps items in cache if accessed (wrong behavior) [`f2d8953`](https://github.com//avoidwork/tiny-lru.git/commit/f2d8953b4b36f15c6587362ae34362bb89acea09)
- Version bump to release, updating LICENSE.md & README.md years [`f16fc2e`](https://github.com//avoidwork/tiny-lru.git/commit/f16fc2e77fb0bae5f2067b030aa1368c2e1f98a5)
- Updating CHANGELOG.md [`683f030`](https://github.com//avoidwork/tiny-lru.git/commit/683f030c52af26041af3be3f42f5a99316651197)

#### [7.0.6](https://github.com//avoidwork/tiny-lru.git/compare/7.0.5...7.0.6)

> 6 June 2020

- Updating CHANGELOG.md [`42dc1ba`](https://github.com//avoidwork/tiny-lru.git/commit/42dc1bab98c2f7a3409e33b6204e62082a7e4636)
- Removing prototype from `this.items{}` [`1ec0ff8`](https://github.com//avoidwork/tiny-lru.git/commit/1ec0ff8183fb719c1061503489f7352672852791)

#### [7.0.5](https://github.com//avoidwork/tiny-lru.git/compare/7.0.4...7.0.5)

> 6 June 2020

- Re-fixing #37 [`f4f372b`](https://github.com//avoidwork/tiny-lru.git/commit/f4f372b6627e8901c70de6d5975fa7448e03fbc7)

#### [7.0.4](https://github.com//avoidwork/tiny-lru.git/compare/7.0.3...7.0.4)

> 29 May 2020

- Revert "Fixing `set()` bug by assigning `expiry` in all cases, adding test, fixes #36" [`#36`](https://github.com//avoidwork/tiny-lru.git/issues/36)
- Updating CHANGELOG.md [`b879ea4`](https://github.com//avoidwork/tiny-lru.git/commit/b879ea48f631f6083bf7a3251083c9c0e2b971c8)
- Reverting 7.0.3 due to possibility of items staying in cache forever [`65b9270`](https://github.com//avoidwork/tiny-lru.git/commit/65b92708b641edd5b8011186739c91007f1d6f0d)

#### [7.0.3](https://github.com//avoidwork/tiny-lru.git/compare/7.0.2...7.0.3)

> 28 May 2020

- Moved to using rollup directly instead of tslib-cli [`#38`](https://github.com//avoidwork/tiny-lru.git/pull/38)
- Bump acorn from 5.7.3 to 5.7.4 [`#36`](https://github.com//avoidwork/tiny-lru.git/pull/36)
- Add `undefined` as possible return type from `get` in TS types [`#34`](https://github.com//avoidwork/tiny-lru.git/pull/34)
- Fixing `set()` bug by assigning `expiry` in all cases, adding test, fixes #37 [`#37`](https://github.com//avoidwork/tiny-lru.git/issues/37)
- Using `auto-changelog` to generate a formatted changelog [`d099c3f`](https://github.com//avoidwork/tiny-lru.git/commit/d099c3fc4e6187f8b8b9f5a23dd2d682a7ef16e1)
- Updating dependencies [`99ec4ca`](https://github.com//avoidwork/tiny-lru.git/commit/99ec4ca1975232e9ae2d0924efefdf6790f1388c)
...
- Version bump to release new type definition [`1cf5b1d`](https://github.com//avoidwork/tiny-lru.git/commit/1cf5b1ddbb183fa0a1b9b4f6276041d8f198435b)
...
#### [6.1.0](https://github.com//avoidwork/tiny-lru.git/compare/6.0.1...6.1.0)
...
- Missed changing calls to `this.remove()` [`37ad9b8`](https://github.com//avoidwork/tiny-lru.git/commit/37ad9b8f09e1e987fa719563fb359f4977f09359)
...
#### [3.0.5](https://github.com//avoidwork/tiny-lru.git/compare/3.0.4...3.0.5)
...
### [2.0.0](https://github.com//avoidwork/tiny-lru.git/compare/1.6.4...2.0.0)
...
- Webstorm @#$#@%@# [`ae4fe0a`](https://github.com//avoidwork/tiny-lru.git/commit/ae4fe0a321924d1922f3e48630fee498b91c3384)
...
#### [1.3.3](https://github.com//avoidwork/tiny-lru.git/compare/1.3.2...1.3.3)
...
#### [1.3.0](https://github.com//avoidwork/tiny-lru.git/compare/1.2.1...1.3.0)
...
- Adding `"use strict";` to `intro.js` [`e86d4ee`](https://github.com//avoidwork/tiny-lru.git/commit/e86d4ee289216ae5578ac6b6b80c7b1a24f97a2e)

#### [1.2.1](https://github.com//avoidwork/tiny-lru.git/compare/1.2.0...1.2.1)

> 14 November 2016

- Creating `merge()` to be the completion of `dump()` for duplicating state between caches [`9e4195f`](https://github.com//avoidwork/tiny-lru.git/commit/9e4195fc720d50209186f50872cd4153b88eb8b3)

#### [1.2.0](https://github.com//avoidwork/tiny-lru.git/compare/1.1.0...1.2.0)

> 14 November 2016

- Removing `LRUItem` class, creating `clone()` & `dump()`, cloning values on `set()` & `get()` so the cache is pristine, adding tests [`52df3a9`](https://github.com//avoidwork/tiny-lru.git/commit/52df3a9697e75a5eedb5d9e25562fc9b87b2f950)
- Adding a bower config [`7202699`](https://github.com//avoidwork/tiny-lru.git/commit/72026998707458ae62eee7651f8f715402f148af)
- Updating bower config to ignore more files [`a73e37a`](https://github.com//avoidwork/tiny-lru.git/commit/a73e37ad64a97006ca52ab4c93e6e01e977d6ddd)
...
- Minor tweak to code structure, added docs [`5f000f8`](https://github.com//avoidwork/tiny-lru.git/commit/5f000f86c7b360e928b3aedfe7abec50a391638f)
